...
/**
 * Header Component — Production-Ready Responsive Navigation
 * 
 * Features:
 * - Logo on the left
 * - Desktop: all navigation links with icons
      ...
      <header className={`header ${isScrolled ? "scrolled" : ""}`}>
        <div className="header-container">
          ...
          <Link to="/" className="header-logo" aria-label="JP Furnishing Home">
            <img src={logo} alt="JP Furnishing Logo" className="logo-image" />
